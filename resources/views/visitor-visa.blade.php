<x-front-layout :page-title="TITLE_VISITOR_VISA" :current-route-name="Route::currentRouteName()" bg-url="2020/08/page-title.jpg">
                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/visitor-visa-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    With its vast lands, natural beauties and beautiful
                                                                    landscapes, Canada receives over 30 million tourists
                                                                    each year. Whether you are looking to come and
                                                                    experience the beauties of Canada, or you want to come
                                                                    and visit your friends and loved ones, we can offer you
                                                                    that exceptional service.
                                                                </p>
                                                            </div>
                                                            <div class="btn-box">
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    Today and we would be able to assist you with your
