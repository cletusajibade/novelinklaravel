<x-front-layout :page-title="TITLE_SPONSORSHIP" :current-route-name="Route::currentRouteName()" bg-url="2020/08/page-title.jpg">
                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/sponsorship-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    Are you a Canadian permanent resident or citizen who is
                                                                    looking to sponsor your spouse, dependent children or
                                                                    parents to Canada, we can offer you that service that
                                                                    takes the stress off your shoulders and turn in that
                                                                    convincing application to enable you reunite with your
                                                                    family members.
                                                                </p>
                                                            </div>
                                                            <div class="btn-box">
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    To speak with us regarding your sponsorship application
                                                                    and we would be able to assist you with your family
