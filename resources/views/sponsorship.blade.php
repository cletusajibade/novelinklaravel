                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    Are you a Canadian permanent resident or citizen who
                                                                    is
                                                                    looking to sponsor your spouse, dependent children
                                                                    or
                                                                    parents to Canada, we can offer you that service
                                                                    that
                                                                    takes the stress off your shoulders and turn in that
                                                                    convincing application to enable you reunite with
                                                                    your
                                                                    family members.
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    To speak with us regarding your sponsorship
                                                                    application
