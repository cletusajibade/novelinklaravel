                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column" style="margin:12px 0">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/study-permit-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    Canada welcomes a huge number of temporary residents who
                                                                    want to come to work, study, visit or as tourists. While
                                                                    some foreigners come from visa exempt countries and are
                                                                    only required to obtain electronics travel authorization
                                                                    (ETA), others require a visa to travel to Canada.
                                                                </p>
                                                                <p>
                                                                    If you
                                                                    are coming to study or work, you may also be required to
                                                                    obtain a permit to enable you engage in those activities
                                                                    while in Canada. </p>

                                                                <span>
                                                                    <p>Let’s know what your needs are, and we would be able to provide you with the expert advice suitable to your needs</p>
                                                                </span>
                                                            </div>
