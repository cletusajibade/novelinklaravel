<x-front-layout :page-title="TITLE_FED_SKILLED_TRADES" :current-route-name="Route::currentRouteName()" bg-url="2020/08/page-title.jpg">
    <section
                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="{{ asset('uploads/2020/07/federal-skilled-trades-1.jpg') }}"
                                                        ...
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    ...
                                                                    can
                                                                    apply to become permanent residents based on their
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    Today to speak with us and we will assist you to
                                                                    take
                                                                    the right steps towards your Canadian immigration.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
