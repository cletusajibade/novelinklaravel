@php
     $action_icons = [
        "icon:chat-bubble-bottom-center-text | click:sendMessage('{duration}', '{appointment_date}', '{appointment_time}')",
        "icon:pencil | color:green | click:redirect('/appointments/{id}')",
        "icon:trash | color:red | click:deleteAppointment('{id}', '{appointment_date}','{appointment_time}')",
    ];

    $data = json_encode($appointments->toArray());
@endphp
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <x-bladewind::table :data="$data" include_columns="client_id,appointment_date,appointment_time,status,notes,payment_status"
