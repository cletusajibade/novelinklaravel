<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg mb-7">
                <div class="grid grid-cols-3 gap-5 mt-7 mb-7 mr-3 ml-3">
                    ...
                    <x-bladewind::statistic icon_position="right" number="{{$appointmentsCount}}" label="Total Appointments">
                        <x-slot name="icon">
