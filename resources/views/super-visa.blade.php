                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="{{ asset('uploads/2020/07/super-visa-1.jpg') }}"
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    With Canada’s Super Visa, parents and grandparents
                                                                    can
                                                                    visit their children and / or grandchildren in
                                                                    Canada
                                                                    and be able to stay for a period of up to 5 years at
                                                                    a
                                                                    time. Super visas provide multiple entry of up to 10
                                                                    years. It takes away the stress of going in and out
                                                                    of
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    To speak with us regarding the eligibility
                                                                    requirements
