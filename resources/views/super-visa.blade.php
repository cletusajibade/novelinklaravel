<x-front-layout :page-title="TITLE_SUPER_VISA" :current-route-name="Route::currentRouteName()" bg-url="2020/08/page-title.jpg">
                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/super-visa-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    With Canada’s Super Visa, parents and grandparents can
                                                                    visit their children and / or grandchildren in Canada
                                                                    and be able to stay for a period of up to 5 years at a
                                                                    time. Super visas provide multiple entry of up to 10
                                                                    years. It takes away the stress of going in and out of
                                                                    Canada if you wish to stay for an extended period of
                                                                    time.
                                                                </p>
                                                            </div>
                                                            <div class="btn-box">
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    To speak with us regarding the eligibility requirements
                                                                    and how to put in your super visa application.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
