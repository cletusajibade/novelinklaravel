                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/provincial-nomination-programs-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    ...
                                                                    they find suitable to their provincial needs by giving
                                                                    them nominations that allow them to apply for permanent
                                                                    residency.
                                                                </p>
                                                                <p>
