                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="{{ asset('uploads/2020/07/work-permit-1.jpg') }}"
                                                        ...
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    ...
                                                                    industries, such as professional and technology
                                                                    services
                                                                    sectors, Canada issues different types of
                                                                    work-permits
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    So that we can offer you expert service on
                                                                    processing
