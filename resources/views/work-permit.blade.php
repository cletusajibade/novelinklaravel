<x-front-layout :page-title="TITLE_WORK_PERMIT" :current-route-name="Route::currentRouteName()" bg-url="2020/08/page-title.jpg">
                                            ...
                                            <div class="row align-items-center clearfix">
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/work-permit-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                                    <div id="content_block_1">
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    Canada is increasingly reliant on temporary foreign
                                                                    workers to meet its labour market needs. From
                                                                    lower-skilled sectors such as those in agriculture,
                                                                    accommodation, and food services to higher-skilled
                                                                    industries, such as professional and technology services
                                                                    sectors, Canada issues different types of work-permits
                                                                    to authorise individuals to work.
                                                                </p>
                                                            </div>
                                                            <div class="btn-box">
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    So that we can offer you expert service on processing
