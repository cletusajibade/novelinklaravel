                        ...
                        "></div>
                                        <div class="auto-container">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column" style="margin:12px 0">
                                                    <div id="image_block_1">
                                                        <div class="image-box">
                                                            <figure class="image">
                                                                <img src="uploads/2020/07/federal-skilled-workers-1.jpg" title="about-1" alt="about-1" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="content-box">
                                                            ...
                                                            <div class="bold-text">
                                                                <p>
                                                                    ...
                                                                    government of Canada through the Immigration, Refugees
                                                                    and Citizenship Canada assists the entry of permanent
                                                                    residents in a way that maximizes their economic, social
                                                                    and cultural contribution to Canada, while at the same
                                                                    time protecting the health, safety and security of
                                                                    Canadians.
                                                                </p>
                                                                <p>
                                                                    There are different pathways that have been
                                                                    designed through which citizens of other countries can
                                                                    become Canadian Permanent Residents.
                                                                </p>
                                                                <p>
                                                                    If you are looking to make Canada your home, you might
                                                                    be eligible for one or some of the available pathways.
                                                                </p>

                                                                <span>
                                                                    <p>Canada’s Express Entry system allows eligible Candidates apply for permanent residence under one of the following programs:</p>
                                                                </span>
                                                            </div>
                                                            <div class="btn-box">
                                                            ...
                                                            <div class="text">
                                                                <p>
                                                                    Today to speak with an Immigration expert and we would
